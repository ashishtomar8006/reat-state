  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <div className="relative z-10 text-center px-8 max-w-4xl">
          ...
          >
            <motion.h1
              ...
              className="text-6xl md:text-5xl font-bold bg-gradient-to-r from-white via-primary to-purple-400 bg-clip-text text-transparent"
            >
        ...
        >
          © 2025 Epistige of Prestige - Premium Properties
        </motion.div>
